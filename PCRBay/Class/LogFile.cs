...
namespace PCRBAY
{
    public class Logfile
    {
        ...
        string dirComportLog = System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetEntryAssembly().Location) + "\\ComportLog\\";//Directory.GetCurrentDirectory() + "\\ComportLog\\";
