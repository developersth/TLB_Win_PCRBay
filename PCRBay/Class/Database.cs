        ...
        public string ServiceName()
        {
            ...
            switch (currentDB)
            {
                case DB_TYPE.DB_MASTER:
                    ...
                    _ServiceName = "Server A";
                    _ServiceName = _ServiceName + "-" + oraConn.DatabaseName + "";
                    break;
                case DB_TYPE.DB_BACKUP:
                    //vMsg = ">Database Connect-> Submaster";
                    _ServiceName = "Server B";
                    _ServiceName = _ServiceName + "-" + oraConn.DatabaseName + "";
                    break;
                default:
                    //vMsg = ">Database Connect-> NONE";
                    _ServiceName = "Server = N/A";
                    break;
            }
            return _ServiceName.ToUpper();
        }

        public string DatabaseInfo()
        {
            return string.Format("Host Name:{0}",oraConn.HostName);
        }
        #endregion
